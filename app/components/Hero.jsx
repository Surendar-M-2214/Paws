...
const Hero = () => {
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div className="w-auto mb-20 order-1  lg:order-2 lg:mt-0 lg:col-span-5 lg:flex lg:w-[500px] shadow-2xl shadow-black rounded-tl-3xl rounded-br-3xl ring-2 ring-black ring-offset-4 ">
